...
const findEquivalenceIndex = (numbers) => {
  const len = numbers.length;
  let leftSum = 0;
  let rightSum = numbers.reduce((acc, cur) => acc + cur, 0);
...
console.log(findEquivalenceIndex([1, 100, 50, -51, 1, 1]));
console.log(findEquivalenceIndex([1, 2, 3, 4, 3, 2, 1]));
console.log(findEquivalenceIndex([50, -51, 1, 1]));
console.log(findEquivalenceIndex([20, 10, -80, 10, 10, 15, 35]));
console.log(findEquivalenceIndex([23, -100, -80, 2, 56, 15, 1]));
