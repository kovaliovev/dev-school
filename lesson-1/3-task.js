...
const countCubes = (totalVolume) => {
  let calculatedVolume = 0;
  let cubeNum = 1;

  while (calculatedVolume < totalVolume) {
    calculatedVolume += cubeNum ** 3;
    if (calculatedVolume === totalVolume) return cubeNum;
    cubeNum++;
  }
  return -1;
};

console.log(countCubes(1));
console.log(countCubes(1071225));
console.log(countCubes(91716553919377));
